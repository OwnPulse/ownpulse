...
-- Recreate partial indexes to exclude both terminal statuses
...
DROP INDEX idx_friend_shares_friend;
CREATE INDEX idx_friend_shares_friend ON friend_shares(friend_id)
  WHERE status NOT IN ('revoked', 'declined');
